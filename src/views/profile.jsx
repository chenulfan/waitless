...
const Profile = () => {
  ...
  const fetchUserData = async (username) => {
    try {
      // correct the URL
      const response = await fetch(`http://localhost:3030/users/${username}`);
            ...
            <div class="grid grid-cols-2">
              <div>
                <div class="flex items-center space-x-2 font-semibold text-gray-900 leading-8 mb-3">
                  ...
                  <span class="tracking-wide">Active Requests</span>
                </div>
                <ul class="list-inside space-y-2">
                  <li>
                    <div class="text-teal-600">Restaurant Name</div>
              ...
              <div>
                <div class="flex items-center space-x-2 font-semibold text-gray-900 leading-8 mb-3">
                  ...
                  <span class="tracking-wide">Active Offers</span>
                </div>
                <ul class="list-inside space-y-2">
                  <li>
                    <div class="text-teal-600">Restaurant Name</div>
